...
def tf_games(request):
    ...
    return render(request, "tf/tf_games.html", {'tf_matches' : tf, 'su' : su, 'plot_div':plot_div})
...
def charts(request):
    ...
    return render(request, "tf/charts.html", {'su' : su, 'plot_div':plot_div})
